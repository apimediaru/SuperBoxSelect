...
$_lang['superboxselect.selectPackage_desc'] = 'Имя папки пакета, с которого извлекается `types\' процессора getlists.';
...
$_lang['superboxselect.valueField'] = 'Поле значений';
$_lang['superboxselect.valueField_desc'] = 'Имя поля, значение которого хранится в переменной шаблона. По умолчанию: <code>id</code>';
