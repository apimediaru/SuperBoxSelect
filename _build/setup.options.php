...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install SuperBoxSelect</h2>

        <p>Thanks for installing SuperBoxSelect. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade SuperBoxSelect</h2>

        <p>SuperBoxSelect will be upgraded. This open source extra was developped by
