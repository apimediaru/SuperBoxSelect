    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            if ($oldPackage && $oldPackage->compareVersion('3.0.0', '>')) {
                $cleanup = [
                    'core' => [
                        'core/components/superboxselect/processors/mgr/selecttypes/tpl',
                        'components/superboxselect/processors/types/options.class.php'
                    ]
                ];
                cleanupFolders($modx, $corePath, $assetsPath, $cleanup, 'SuperBoxSelect', '3.0.0');
                cleanupPluginEvents($modx, 'SuperBoxSelect', ['OnDocFormRender']);
            }
            $success = true;
            break;
